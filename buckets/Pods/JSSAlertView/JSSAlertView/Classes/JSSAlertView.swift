...
open class JSSAlertView: UIViewController {
	...
	var titleFont = "Avenir-Heavy"
	var textFont = "Avenir-Heavy"
	var buttonFont = "Avenir-Heavy"
    var timerFont = "Avenir-Heavy"
	...
	public func show(_ viewController: UIViewController,
		...
		if let text = text {
			...
			textView.font = UIFont(name: self.textFont, size: 28)
